...
from src.utils.fnc.boundary import searchOuterBound, searchInnerBound
from src.utils.fnc.line import linecoords, findline
...
def segment(eyeim):
    ...
    # If the code is run on macOS, the multiprocessing library must be used with the 'spawn' method
